...
loaded_model.load_state_dict(torch.load('traffic_model.pth'))
loaded_model.eval()

# Predict using the test dataset
for input_path, label in training_dataset.samples:
    ...
    predicted_class_label = training_dataset.classes[predicted_class.item()]
